    ...
    <section id="about" className="scroll-mt-24 relative py-4 px-4 md:px-0">
      ...
      >
        <motion.div 
          ...
          className="hyper-card md:col-span-2 p-16 md:p-24 flex flex-col justify-center group"
        >
        ...
        <motion.div 
          variants={itemVariants}
          className="hyper-card p-16 flex flex-col items-center justify-center group text-center"
        >
          <div className="glow-chase-overlay" />
          <div className="text-8xl font-black text-white font-outfit mb-6 tracking-tighter group-hover:scale-110 transition-all duration-[2s]">2+</div>
        ...
        <motion.div 
          variants={itemVariants}
          className="hyper-card md:col-span-2 p-16 flex items-center justify-around group"
        >
          <div className="glow-chase-overlay" />
          <div className="flex items-center gap-16 md:gap-24 flex-wrap justify-center opacity-40 group-hover:opacity-100 transition-all duration-1000">
