  ...
  return (
    <section id="skills" className="scroll-mt-24 relative py-4 px-4 md:px-0">
      ...
      <motion.div 
        ...
        className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-10 lg:gap-14"
      >
        {skillsData.map((skill, i) => (
          <motion.div
            ...
            className="group relative flex flex-col items-center justify-center text-center hyper-card p-6 md:p-12 transition-all duration-[1200ms] aspect-square"
          >
