    ...
    <section id="work" className="scroll-mt-24 relative py-4 px-4 md:px-0">
      ...
      >
        {workData.map((job, idx) => (
          ...
          >
            <div className="hyper-card p-10 md:p-16 flex flex-col lg:flex-row gap-12 items-start transition-all duration-1000 group-hover:bg-white/[0.03] relative z-10">
