...
const Hero = () => {
  ...
  return (
    <section className="min-h-[70vh] flex flex-col items-center justify-center relative pt-2 mb-2 overflow-visible">
      ...
      >
        <div className="relative group p-10 md:p-20 rounded-[5.5rem] overflow-visible">
          {/* Subtle Shared Glow */}
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-16 md:gap-32">
            {/* LEFT SIDE: NAME & TAGLINE */}
            <div className="flex-1 text-center md:text-left space-y-10 order-2 md:order-1">
              <motion.div
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
              >
                <h1 className="text-6xl md:text-[8rem] font-bold leading-[0.8] tracking-tighter select-none font-outfit uppercase">
                  mahammad<br />
              ...
              <motion.p
                ...
                className="text-xs md:text-lg text-slate-400 max-w-xl font-medium lowercase tracking-[0.4em]"
              >
              ...
              <motion.div 
                ...
                className="pt-8"
              >
                <a href={resumeLink} target="_blank" rel="noopener noreferrer" className="btn-premium-stable px-12 py-7 inline-flex rounded-full group">
                  <span className="flex items-center gap-6 text-[9px] font-bold tracking-[0.5em] text-slate-300 group-hover:text-creative transition-all">
            ...
            >
              <div className="relative group-photo">
                 ...
                 <div className="relative w-64 h-80 md:w-[22rem] md:h-[30rem] overflow-hidden rounded-[4rem] md:rounded-[5rem] border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.8)] transition-all duration-1000 group-hover:rounded-[2rem] group-hover:scale-[1.02]">
                    <img 
                      src="https://raw.githubusercontent.com/MahammadFayazShaik/portfolio/master/image.jfif" 
                      alt="Mahammad Fayaz" 
